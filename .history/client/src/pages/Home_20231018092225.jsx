          ...
          <div>
            ...
            {todos.map((todo, index) => {
              return (
                <div
                  key={index}
                  className="w-[70] flex md:flex-row flex-col my-2 justify-between items-center">
                 <div className="flex border-b-[1px] w-full items-baseline"> {index+1}<TodosLIst task={todo.text} /></div>
                </div>
              );
            })}
          </div>
