        ...
        <div>
          ...
          <div>
              ...
              <div className="flex flex-row">
                ...
                {text.length < 5 ? (
                  <Button
                    ...
                    variant="contained"
                    onClick={() => alert("Task has to be at least 5 digits")}
                  >
                    Type
                  </Button>
                ) : (
            ...
            {todos.map((todo, index) => {
              return (
                <div key={index} className="flex lg:flex-row sm:flex-col my-2 justify-between items-center">
                  <p className=" font-bold ">{index + 1}.</p>
                  <div className=" font-cursive text-xl ">{todo.text}</div>
