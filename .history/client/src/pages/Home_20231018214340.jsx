            ...
            {todos.map((todo, index) => {
              return (
                <div key={index} className="my-4">
                  <div
                    className={`${
                      todo.completed && "bg-gray-200 opacity-[0.7] relative "
                    } rounded-xl flex flex-col lg:flex-row justify-between
                 hover:bg-blue-200 px-5 border-l-[3px] border-blue-600 items-baseline `}
                  >
                    {todo.completed && (
                      <span className="absolute z-10 top-[40%] left-[10%] text-red-500 text-3xl">
                        Completed{" "}
                      </span>
                    )}
