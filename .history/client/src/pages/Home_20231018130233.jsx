          ...
          <div>
            ...
            {todos.map((todo, index) => {
              return (
                ...
                >
                  <div className="flex justify-between hover:bg-slate-100 px-3 border-b-[1px] w-full items-baseline">
                    {index + 1}.<TodosLIst task={todo.text} /> <Buttons />
                  </div>
                </div>
              );
            })}
